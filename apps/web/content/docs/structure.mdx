...
| `@fabrik-sdk/ui/openai` | OpenAI provider | Server |
| `@fabrik-sdk/ui/anthropic` | Anthropic provider | Server |
| `@fabrik-sdk/ui/google` | Google Gemini provider | Server |
| `@fabrik-sdk/ui/ai-sdk` | Vercel AI SDK adapter | Server |
